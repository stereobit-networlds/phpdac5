...
parse_config_file('html2ps/html2ps.config');
...
convert_to_pdf('invoice-template.htm', "temp.pdf");
...
class html2ps
{
 ...
 public function __construct($import_data=null, $job_id=null, $job_file=null, $job_attr=null) {
 ...
 public function execute() {
	...
	$this->convert_to_pdf($this->jf, "temp.pdf");
    
	$this->export_data = file_get_contents("temp.pdf");
