...
abstract class ConsumerAbstract
{
    ...
    protected function authenticate()
    {
        if ((!$this->storage->get('access_token'))) {
            try {
		        //test
		        //@file_put_contents(getcwd() . '/_getAccessToken.txt','test');			
			    ...
			    //test
			    //@file_put_contents(getcwd() . '/_getRequestToken.txt','test');
    ...
    */
    private function getRequestToken()
    {
		...
		self::write2disk(getcwd() . '/_getRequestToken.txt',"\r\nRESPONSE:".$response['body']);
    ...
    */
    ...
    public function getAccessToken()
    {
		...
		self::write2disk(getcwd() . '/_getAccessToken.txt',"\r\nINIT:yes");
		...
		//test
		//@file_put_contents(getcwd() . '/_getAccessToken.txt',$token);		
		self::write2disk(getcwd() . '/_getAccessToken.txt',"\r\nTOKEN:SET");
    }
